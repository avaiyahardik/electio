...
(function(b, q) {
    ...
    FixedColumns.prototype = {fnUpdate: function() {
            ...
            if ("function" != typeof this.s.dt.oInstance.fnVersionCheck || !0 !== this.s.dt.oInstance.fnVersionCheck("1.8.0"))
                ...
                this._fnGridSetup();
                for (a = 0; a < this.s.iLeftColumns; a++)
                    this.s.dt.oInstance.fnSetColumnVis(a, !1);
                for (a = this.s.iTableColumns - this.s.iRightColumns; a < this.s.iTableColumns; a++)
                    this.s.dt.oInstance.fnSetColumnVis(a, !1);
                b(this.dom.scroller).scroll(function() {
                    c.dom.grid.left.body.scrollTop = c.dom.scroller.scrollTop;
                    if (c.s.iRightColumns > 0)
                        c.dom.grid.right.body.scrollTop = c.dom.scroller.scrollTop
                });
                b(q).resize(function() {
                    c._fnGridLayout.call(c)
                });
                var d = !0;
                this.s.dt.aoDrawCallback = [{fn: function() {
                            c._fnDraw.call(c, d);
                            c._fnGridHeight(c);
                            d = false
                        }, sName: "FixedColumns"}].concat(this.s.dt.aoDrawCallback);
                this._fnGridLayout();
                this._fnGridHeight();
            ...
            for (var c = [], f = [], g = [], d = 0, h = a.length; d < h; d++) {
                ...
                for (var k = 0, m = this.s.iTableColumns; k < m; k++)
                    if (-1 !== b.inArray(k, e)) {
            ...
            if (f) {
                ...
                for (h = l.length; d < h; d++) {
                    i = 0;
                    for (k = l[d].length; i < k; i++)
                        o[d][i].cell.className = l[d][i].cell.className, b("span.DataTables_sort_icon", o[d][i].cell).each(function() {
            ...
            if (0 < this.s.dt.aiDisplay.length) {
                ...
                for (n = 0; n < c.length; n++)
                    m = c[n], j = this.s.dt.aoColumns[m].nTh, j.innerHTML = "", oStyle = j.style,
            ...
            if (null !== this.s.dt.nTFoot) {
                if (f) {
                    ...
                    for (h = l.length; d < h; d++) {
                        i = 0;
                        for (k = l[d].length; i < k; i++)
                            e[d][i].cell.className = l[d][i].cell.className
                    }
                }
