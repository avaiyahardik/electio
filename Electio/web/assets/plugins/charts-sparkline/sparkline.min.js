(function(e, t, n) {
    (function(e) {
        ...
        O = ".jqstooltip { " + "position: absolute;" + "left: 0px;" + "top: 0px;" + "visibility: hidden;" + "background: rgb(0, 0, 0) transparent;" + "background-color: rgba(48,48,48,0.8);" + "filter:progid:DXImageTransform.Microsoft.gradient(startColorstr=#99000000, endColorstr=#99000000);" + '-ms-filter: "progid:DXImageTransform.Microsoft.gradient(startColorstr=#99000000, endColorstr=#99000000)";' + "color: white;" + "font: 10px arial, san serif;" + "text-align: left;" + "white-space: nowrap;" + "padding: 5px 25px 15px 5px;" + "border: none;" + "z-index: 10000;" + "}" + ".jqsfield { " + "color: white;" + "font: 11px arial, san serif;" + "text-align: center;" + "}";
        o = function() {
            var e, t;
            e = function() {
        ...
        r.fn.sparkline.box = A = o(r.fn.sparkline._base, {type: "box", init: function(e, t, n, i, s) {
                ...
                var e = [{field: "lq", value: this.quartiles[0]}, {field: "med", value: this.quartiles[1]}, {field: "uq", value: this.quartiles[2]}];
                if (this.loutlier !== n) {
