/*! jQRangeSlider 5.6.0 - 2014-02-01 - Copyright (C) Guillaume Gautreau 2012 - MIT and GPLv3 licenses.*/!function(a) {
    "use strict";
    ...
    a.widget("ui.rangeSliderHandle", a.ui.rangeSliderDraggable, {currentMove: null, margin: 0, parentElement: null, options: {isLeft: !0, bounds: {min: 0, max: 100}, range: !1, value: 0, step: !1}, _value: 0, _left: 0, _create: function() {
            ...
            var d = null === this.cache.parent.offset ? 0 : this.cache.parent.offset.left, e = this.cache.parent.width, f = e > 0 ? (a - d) / e : 0;
            return f * (c - b) + b
        }, value: function(a) {
    ...
    a.widget("ui.rangeSliderBar", a.ui.rangeSliderDraggable, {options: {leftHandle: null, rightHandle: null, bounds: {min: 0, max: 100}, type: "rangeSliderHandle", range: !1, drag: function() {
            ...
            if (this._cacheIfNecessary(), b.element[0] === this.options.leftHandle[0]) {
                if (this._switchedValues())
                    return this._switchHandles(), this._onDragRightHandle(a, b), void 0;
            ...
            if (this._cacheIfNecessary(), b.element[0] === this.options.rightHandle[0]) {
                if (this._switchedValues())
                    return this._switchHandles(), this._onDragLeftHandle(a, b), void 0;
    ...
    function b(b, c, d, e) {
        this.label1 = b, this.label2 = c, this.type = d, this.options = e, this.handle1 = this.label1[this.type]("option", "handle"), this.handle2 = this.label2[this.type]("option", "handle"), this.cache = null, this.left = b, this.right = c, this.moving = !1, this.initialized = !1, this.updating = !1, this.Init = function() {
            ...
            if (this.CacheIfNecessary(), null !== this.cache) {
                var a, b = this.GetRawPosition(this.cache.label1, this.cache.handle1), c = this.GetRawPosition(this.cache.label2, this.cache.handle2);
                (c.left - b.left) * (this.cache.handle2.value - this.cache.handle1.value) <= 0 && (a = b, b = c, c = a), this.ConstraintPositions(b, c), this.PositionLabel(this.label1, b.left, this.cache.label1), this.PositionLabel(this.label2, c.left, this.cache.label2)
            }
