...
<%
    ...
    boolean show_add_voter = (Boolean) request.getAttribute("show_add_voter");
%>
<div id="main-content">
        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <%} else {%>
                    <strong> Add voter disabled during voting period</strong>
                    <%}%><br><br>
                    <div class="well">
                        <div class="row">   
                            ...
                            <div class="align-right col-lg-6">
                                ...
                                <% if (show_add_voter) {%>  <a href="Controller?action=send_ballot_link&election_id=<%= el.getId()%>" class="btn btn-primary align-right btn-sm"><i class="fa fa-envelope"></i> Send Ballot URL</a><% }%>
                            </div>
                        </div>
                    </div>
